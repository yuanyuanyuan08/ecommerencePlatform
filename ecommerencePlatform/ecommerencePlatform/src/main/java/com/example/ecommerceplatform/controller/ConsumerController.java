...
public class ConsumerController {
    ...
    private void updateProductList(String searchStr, boolean searchMerchant) {
        // 根据searchStr查找所有产品，当seachStr为空时，展示所有商品。
        List<Product> productList = new ArrayList<>();

        if (!searchMerchant){ //查找商品
        productList = consumer.getProductListByTag(searchStr);//根据搜索获得商品列表
        }else { //查找商家
            productList = consumer.getProductListByMerchantId(searchStr);
        }
    ...
    public void handleSearchProduct(ActionEvent actionEvent) {
        ...
        updateProductList(search,false);
    }
    public void handleSearchMerchant(ActionEvent actionEvent) {
        String search = searchField.getText();
        updateProductList(search,true);
    }
    ...
    public class ProductListCell extends ListCell<Product> {
        ...
        private final Text merchantText = new Text();
        ...
        public ProductListCell() {
            ...
            merchantText.setStyle("-fx-text-fill: #0076a3;");
            ...
            // 组装布局
            infoBox.getChildren().addAll(nameText,merchantText, priceText, stockText, tagsText);
        ...
        protected void updateItem(Product product, boolean empty) {
            ...
            if (empty || product == null) {
                ...
                merchantText.setText("Merchant Name: "+ product.getMerchantName());
